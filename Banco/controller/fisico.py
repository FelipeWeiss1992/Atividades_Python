...
- Coloque o atributo da função create_psf (conta) dentro de parênteses convertido para string.write(str(conta)) , faça com que cada dado inserido seja escrito na próxima linha utilizando quebra de linha, '\n'
...
Crie um objeto de conta e chame cada atributo da nossa classe, inclusive os dados da classe base (Conta) agencia, numero_agencia, titular, cpf e saldo_incial.
